...
class MLP(Model):
    ...
    def _loss(self):
        ...
        # Cross entropy error
        self.loss += cross_entropy(self.outputs, self.placeholders['labels'],
    ...
    def predict(self):
        return tf.nn.log_softmax(self.outputs)
...
class HGCN(Model):
    def __init__(self, placeholders, input_dim, transfer_list, adj_list, node_wgt_list, **kwargs):
        ...
        self.W_node_wgt = tf.Variable(tf.random.uniform([FLAGS.max_node_wgt,FLAGS.node_wgt_embed_dim],
